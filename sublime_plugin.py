# Copyright Jon Skinner and Sublime HQ Pty Ltd.
# THE GPL LICENSE DOES NOT APPLY TO THIS FILE.

"""

This file is based on the identically-named file distributed with Sublime Text 3.

Instead of using this module, you can also just add your Sublime Text installation path
...
print("sublime_plugin module imported.")
